...
namespace DTAClient.Domain.Multiplayer.CnCNet
{
    ...
    public static class MapSharer
    {
        ...
        private static string MapUpload(string _URL, Map map, string gameName, out bool success)
        {
            ...
            string zipFile = ProgramConstants.GamePath + $"Maps\\{ClientConfiguration.Instance.CustomMapFolderName}\\" + map.SHA1 + ".zip";
        ...
        {
            string customMapsDirectory = ProgramConstants.GamePath + $"Maps\\{ClientConfiguration.Instance.CustomMapFolderName}\\";
