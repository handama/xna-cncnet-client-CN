...
namespace DTAClient.Domain
{
    ...
    public class SavedGame
    {
        ...
        const string KUTUZOV_SAVED_GAME_PATH = "Kutuzov Saved Games/";
        ...
        public bool KutuzovMission { get; set; }
        ...
        public bool ParseInfo(string missionType="none")
        {
            try
            {
                if (missionType == "kutuzov")
                {
                    using (BinaryReader br = new BinaryReader(File.Open(ProgramConstants.GamePath + KUTUZOV_SAVED_GAME_PATH + FileName, FileMode.Open, FileAccess.Read)))
                    {
                    ...
                    LastModified = File.GetLastWriteTime(ProgramConstants.GamePath + KUTUZOV_SAVED_GAME_PATH + FileName);
                    return true;
                }
                else
                {
