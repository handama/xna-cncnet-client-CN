...
namespace DTAClient.DXGUI.Multiplayer.CnCNet
{
    ...
    public class CnCNetGameLoadingLobby : GameLoadingLobbyBase
    {
        ...
        public void OnJoined()
        {
            ...
            else
            {
                ...
                if (tunnelHandler.CurrentTunnel.PingInMs < 0)
                    ...
                    AddNotice(ProgramConstants.PLAYERNAME + " - 该隧道服的延迟是：" + tunnelHandler.CurrentTunnel.PingInMs + " ms");
            }
        ...
        protected override void HostStartGame()
        {
            ...
            {
                ShowTunnelSelectionWindow("连接指定的CnCNet隧道服务器时出错。" + Environment.NewLine +
                        "请尝试使用其他隧道服务器：");
                AddNotice("连接指定的CnCNet隧道服务器时出错。请尝试使用其他隧道服务器。", Color.Yellow);
                return;
            }
