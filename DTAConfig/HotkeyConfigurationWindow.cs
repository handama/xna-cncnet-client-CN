...
namespace DTAConfig
{
    ...
    {
        private const string HOTKEY_TIP_TEXT = "请按键";
        ...
        private void Keyboard_OnKeyPressed(object sender, Rampastring.XNAUI.Input.KeyPressEventArgs e)
        {
            ...
            foreach (var command in gameCommands)
            {
                if (pendingHotkey.Equals(command.Hotkey))
                    lblCurrentlyAssignedTo.Text = "已被分配给：" + Environment.NewLine + command.UIName;
            }
        }
        ...
        class GameCommand
        {
            ...
            public GameCommand(IniSection iniSection)
            {
                ...
                Category = iniSection.GetStringValue("Category", "未知种类");
                Description = iniSection.GetStringValue("Description", "没有描述");
